...
public class RCCP_InputManager : RCCP_Singleton<RCCP_InputManager> {
    ...
    public delegate void onGearToggle();
    ...
    private RCCP_Inputs KeyboardInputs() {
        ...
        if (RCCP_Settings.Instance.useNewInputSystem) {
            ...
            if (newInputSystemActions == null) {
                ...
                newInputSystemActions.Vehicle.HighBeamLights.performed += HighBeamHeadlightsPerformed;
                newInputSystemActions.Vehicle.HighBeamLights.canceled += HighBeamHeadlightsCanceled;
                ...
                newInputSystemActions.Camera.Hold.performed += HoldOrbitCameraPerformed;
                newInputSystemActions.Camera.Hold.canceled += HoldOrbitCameraCanceled;
            ...
            if (Input.GetKeyDown(KeyCode.K))
                HighBeamHeadlights(true);
            else
                HighBeamHeadlights(false);
    ...
    public void HighBeamHeadlightsPerformed(InputAction.CallbackContext obj) {

        if (OnPressedHighBeamLights != null)
            OnPressedHighBeamLights(true);

    }

    public void HighBeamHeadlightsCanceled(InputAction.CallbackContext obj) {

        if (OnPressedHighBeamLights != null)
            OnPressedHighBeamLights(false);
