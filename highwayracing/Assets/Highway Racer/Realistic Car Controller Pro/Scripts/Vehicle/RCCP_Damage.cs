...
public class RCCP_Damage : RCCP_Component {
    ...
    /// </summary>
    public bool processInactiveGameobjects = true;
    ...
    /// </summary>
    public float deformationRadius = .75f;
    ...
    /// </summary>
    public bool deformed = true;

    /// <summary>
    /// Timer for deforming the vehicle. 
    /// </summary>
    public float deformationTime = 0f;
    ...
    /// Wheel damage radius.
    /// </summary>
    public float wheelDamageRadius = .75f;
    ...
    /// Light damage radius.
    /// </summary>
    public float lightDamageRadius = .75f;
    ...
    /// Part damage radius.
    /// </summary>
    public float partDamageRadius = .75f;
