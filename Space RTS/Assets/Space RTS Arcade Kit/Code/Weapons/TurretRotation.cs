...
{
    /// <summary>
    /// Kindly borrowed from the always-helpful Why485.
    /// </summary>
   public class TurretRotation : MonoBehaviour
   {
      ...
      /// </summary>
      public bool Idle { get { return !_aiming; } }

      /// <summary>
      /// Turret is idle and in a resting position.
      /// </summary>
      public bool AtRest { get { return _atRest; } }
      ...
      private void RotateBarrels()
      {
         ...
         {
            // Note, the local conversion has to come from the parent.
            Vector3 localTargetPos = turretBase.InverseTransformPoint(_aimPoint);
