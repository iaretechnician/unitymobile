...
public class RCCP_Visual_Dashboard : RCCP_Component {
    ...
    /// </summary>
    public float steeringAngleSmoother = 5f;
    ...
    private void SteeringWheel() {
        ...
        if (steeringWheel) {
            ...
            steeringWheel.transform.localRotation = Quaternion.Slerp(steeringWheel.transform.localRotation, targetRotation, Time.deltaTime * steeringAngleSmoother);
