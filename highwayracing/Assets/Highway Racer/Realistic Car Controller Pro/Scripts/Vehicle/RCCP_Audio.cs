    ...
    private void Gearbox() {
        ...
        if (reverseSound != null && reverseSound.audioClips != null) {
            ...
            if (!reverseSound.audioSource) {
                ...
                reverseSound.audioSource = RCCP_AudioSource.NewAudioSource(gameObject, reverseSound.audioClips.name, reverseSound.minDistance, reverseSound.maxDistance, 0f, reverseSound.audioClips, true, true, false);
        ...
        if (wheelFlatSound != null && wheelFlatSound.audioClips != null) {
            ...
            if (deflated) {
                ...
                if (wheelFlatSound.audioSource == null) {
                    ...
                    wheelFlatSound.audioSource = RCCP_AudioSource.NewAudioSource(gameObject, wheelFlatSound.audioClips.name, 1f, 15f, 0f, wheelFlatSound.audioClips, true, false, false);
    ...
    private void Others() {
        ...
        if (windSound != null && windSound.audioClips != null) {
            ...
            if (!windSound.audioSource) {
                ...
                windSound.audioSource = RCCP_AudioSource.NewAudioSource(gameObject, windSound.audioClips.name, windSound.minDistance, windSound.maxDistance, 0f, windSound.audioClips, true, true, false);
