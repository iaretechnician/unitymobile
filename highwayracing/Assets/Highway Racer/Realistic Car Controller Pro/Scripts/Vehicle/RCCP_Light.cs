    ...
    private void Update() {
        ...
        if (emissiveRenderer) {
            ...
            if (shaderKeywordEmissionEnable != "")
                emissiveRenderer.materials[emissiveMaterialIndex].EnableKeyword(shaderKeywordEmissionEnable);        //  Enabling keyword of the material for emission.

            if (shaderKeywordEmissionColor != "")
                emissiveRenderer.materials[emissiveMaterialIndex].SetColor(shaderKeywordEmissionColor, emissiveColor * LightSource.intensity);
            ...
            for (int i = 0; i < additionalEmissiveRenderers.Length; i++) {
                ...
                if (additionalEmissiveRenderers[i] != null && additionalEmissiveRenderers[i].emissiveRenderer != null && additionalEmissiveRenderers[i].emissiveMaterialIndex >= 0) {
                    ...
                    if (additionalEmissiveRenderers[i].shaderKeywordEmissionEnable != "")
                        additionalEmissiveRenderers[i].emissiveRenderer.materials[additionalEmissiveRenderers[i].emissiveMaterialIndex].EnableKeyword(additionalEmissiveRenderers[i].shaderKeywordEmissionEnable);        //  Enabling keyword of the material for emission.

                    if (additionalEmissiveRenderers[i].shaderKeywordEmissionColor != "")
                        additionalEmissiveRenderers[i].emissiveRenderer.materials[additionalEmissiveRenderers[i].emissiveMaterialIndex].SetColor(additionalEmissiveRenderers[i].shaderKeywordEmissionColor, additionalEmissiveRenderers[i].emissiveColor * LightSource.intensity);
