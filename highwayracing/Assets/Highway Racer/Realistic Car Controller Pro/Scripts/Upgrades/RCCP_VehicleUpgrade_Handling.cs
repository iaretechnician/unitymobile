...
public class RCCP_VehicleUpgrade_Handling : RCCP_Component {
    ...
    /// <summary>
    /// Maximum upgradable handling strength.
    /// </summary>
    [Range(-1f, .6f)] public float maxUpgradedHandlingStrength = -1f;
    ...
    public void Initialize() {
        ...
        if (maxUpgradedHandlingStrength <= 0f)
    ...
    private void CalculateInitialValues() {
        ...
        maxUpgradedHandlingStrength = GetComponentInParent<RCCP_CarController>(true).GetComponentInChildren<RCCP_Stability>(true).tractionHelperStrength + .17f;
