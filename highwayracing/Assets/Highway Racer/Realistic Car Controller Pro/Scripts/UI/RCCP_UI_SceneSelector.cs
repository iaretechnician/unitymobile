...
public class RCCP_UI_SceneSelector : MonoBehaviour {

    public enum DemoScene { AIO, City, CitySelectVehicle, Damage, Transport, Blank, BlankAPI, BlankCustomization, BlankOverrideInputs, PhotonLobby, PhotonCity, CityEnterExitFPS, CityEnterExitTPS, BlankEnterExitFPS, BlankEnterExitTPS, CityTraffic }
    ...
    public void OnClick() {
        ...
        switch (demoScene) {
            ...
            case DemoScene.BlankEnterExitTPS:
                ...
                //                RCCP_DemoAIO.Instance.LoadScene(RCCP_DemoScenes.Instance.GetAssetPath(RCCP_DemoScenes.Instance.demo_City_Traffic));
                //                break;
        ...
        for (int i = 0; i < allScenes.Length; i++) {
            ...
            switch (demoScene) {
                ...
                case DemoScene.CityTraffic:
                    ...
                    if (allScenes[i].path == RCCP_DemoScenes.Instance.GetAssetPath(RCCP_DemoScenes.Instance.demo_City_Traffic))
                        foundScene = true;
