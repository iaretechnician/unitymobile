...
public class RCCP_MobileInputs : MonoBehaviour {
    ...
    public RCCP_UI_DashboardButton gearUp;
    public RCCP_UI_DashboardButton gearDown;
    ...
    private void Update() {
        ...
        if (RCCP_SceneManager.Instance && RCCP_SceneManager.Instance.activePlayerVehicle) {
            ...
            if (RCCP_SceneManager.Instance.activePlayerVehicle.Gearbox) {
                ...
                if (gearUp)
                    gearUp.gameObject.SetActive(!RCCP_SceneManager.Instance.activePlayerVehicle.Gearbox.automaticTransmission);

                if (gearDown)
                    gearDown.gameObject.SetActive(!RCCP_SceneManager.Instance.activePlayerVehicle.Gearbox.automaticTransmission);
                ...
                if (gearDown)
                    gearDown.gameObject.SetActive(false);
